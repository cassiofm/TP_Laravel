...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('funcionarios')->insert(['nome'=>'Maria','endereco'=>'rua Y','departamento_id'=>2]);
        ...
        DB::table('dependentes')->insert(['nome'=>'Jose','parentesco_id'=>'1','funcionario_id'=>'1']);
        DB::table('dependentes')->insert(['nome'=>'Filomena','parentesco_id'=>'2','funcionario_id'=>'2']);
